...
class TransactionType extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'transactions' => array(self::HAS_MANY, 'Transaction', 'transaction_type_id'),
		);
	}
	...
	{
		$transactionTypes = $this->findAll('', array('order' => 'name'));
		$data = array();

		foreach ($transactionTypes as $transactionType) {
			$data[(int)$transactionType->id] = $transactionType->name;
		}
