...
class HighchartsWidget extends CWidget {
	...
	public function run() {
		...
		$this->options = CMap::mergeArray($defaultOptions, $this->options); //var_dump($this->options); die();
		$jsOptions = CJavaScript::encode($this->options);
		$this->registerScripts(__CLASS__ . '#' . $id, "var chart" . $id . " = new Highcharts.Chart($jsOptions);");
	}
